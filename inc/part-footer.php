    ...
    <div class="row align-items-center text-center">
        ...
        <div class="col-md-6 text-md-end pt-2 pt-md-0">
            ...
            foreach ($sosmed as $key => $icon) {
                ...
                if ($datalink) {
                    echo '<a class="btn btn-sm btn-'.$key.' ms-1 border-0 text-white rounded-circle d-inline-flex align-items-center justify-content-center social-circle" href="' . $datalink . '" target="_blank">'.$icon.'</a>';
                }
            }
            ?>
        </div>
